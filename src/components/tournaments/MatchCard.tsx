    ...
    <div className="glass-card p-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className={`font-semibold truncate text-sm ${match.winner_team_id === match.home_team_id ? "text-emerald-400" : "text-[var(--text-primary)]"}`}>
            {homeName}
          </p>
        </div>
        ...
        <div className="shrink-0 text-center">
          {hasScore ? (
            <p className="font-mono font-bold text-base text-[var(--text-primary)]">
        ...
        <div className="flex-1 min-w-0 text-right">
          <p className={`font-semibold truncate text-sm ${match.winner_team_id === match.away_team_id ? "text-emerald-400" : "text-[var(--text-primary)]"}`}>
            {awayName}
          </p>
        </div>
      </div>
