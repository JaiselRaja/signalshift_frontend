...
export async function initiatePayment(bookingId: string): Promise<RazorpayInitiateResponse> {
  return api.post<RazorpayInitiateResponse>("/payments/initiate", { booking_id: bookingId });
}
